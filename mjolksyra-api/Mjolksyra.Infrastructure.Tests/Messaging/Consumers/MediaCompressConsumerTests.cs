...
public class MediaCompressConsumerTests
{
    ...
    public async Task Consume_WhenDownloadFails_LogsWarningAndDoesNotThrow()
    {
        ...
        repository.Verify(x => x.SetMediaCompressedUrl(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Never);
    ...
    [Fact]
    public async Task Consume_OnSuccess_SetsCompressedUrlAtomically()
    {
        ...
        repository.Verify(x => x.SetMediaCompressedUrl(workoutId, rawUrl, compressedUrl, CancellationToken.None), Times.Once);
    }
