...
public class MediaCompressConsumerTests
{
    ...
    [Fact]
    public async Task Consume_OnSuccess_SetsCompressedUrlAndPreservesRawFile()
    {
        ...
        var workout = new PlannedWorkout
        {
            ...
            Media = [new PlannedWorkoutMedia { RawUrl = rawUrl }],
        };
        ...
        // CompressedUrl should be set on the media item; RawUrl preserved
        Assert.NotNull(savedWorkout);
        var item = savedWorkout!.Media.Single(m => m.RawUrl == rawUrl);
