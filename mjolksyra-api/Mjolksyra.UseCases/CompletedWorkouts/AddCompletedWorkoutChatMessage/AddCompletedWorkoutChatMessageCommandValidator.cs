...
public class AddCompletedWorkoutChatMessageCommandValidator : AbstractValidator<AddCompletedWorkoutChatMessageCommand>
{
    public AddCompletedWorkoutChatMessageCommandValidator(IOptions<MediaStorageOptions> mediaStorage)
    {
