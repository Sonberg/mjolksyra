  ...
  function renderTab(tab: TabOption<T>) {
    ...
    return (
      <button
        ...
        className="inline-flex min-w-[7.5rem] flex-1 items-center justify-center whitespace-nowrap px-4 py-2 text-sm font-semibold outline-none transition-[background-color,color] duration-[150ms] ease-[cubic-bezier(0.23,1,0.32,1)] focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-[var(--shell-accent)]/40 focus-visible:ring-offset-0 data-[state=active]:bg-[var(--shell-ink)] data-[state=active]:text-[var(--shell-surface)] data-[state=inactive]:bg-[var(--shell-surface)] data-[state=inactive]:text-[var(--shell-muted)] data-[state=inactive]:hover:bg-[var(--shell-surface-strong)] data-[state=inactive]:hover:text-[var(--shell-ink)]"
