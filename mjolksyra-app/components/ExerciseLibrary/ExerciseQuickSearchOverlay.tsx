    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="space-y-0 border-b-4 border-[var(--shell-border)] bg-[var(--shell-surface-strong)] px-4 py-3">
          ...
          <p className="text-xs font-medium uppercase tracking-[0.08em] text-[var(--shell-muted)]">
        ...
        <div className="max-h-[50vh] overflow-y-auto">
          {isLoading ? (
            ...
            <div className="px-4 py-4 text-sm text-[var(--shell-muted)]">
              {hasSearch ? "No exercises found." : "Start typing to search exercises."}
            </div>
          ) : (
            <div>
        ...
        <div className="flex flex-wrap items-center justify-end gap-3 border-t-4 border-[var(--shell-border)] bg-[var(--shell-surface-strong)] px-4 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-[var(--shell-muted)]">
