...
export const HeroSection = () => {
  return (
    <section className="relative overflow-hidden">
      <div className="pointer-events-none absolute -left-24 top-24 h-72 w-72 rounded-full bg-cyan-300/10 blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-screen-xl gap-8 px-4 pb-12 pt-20 lg:grid-cols-12 lg:pt-32">
        <div className="mr-auto place-self-center lg:col-span-7">
          <div className="mb-6 inline-flex items-center rounded-full border border-cyan-200/20 bg-cyan-300/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-cyan-100">
            Coaching Platform
          </div>
          <h1 className="mb-8 max-w-2xl text-4xl font-extrabold leading-tight tracking-tight md:text-5xl xl:text-6xl">
        ...
        <div className="relative hidden lg:col-span-5 lg:mt-0 lg:flex">
          <div className="absolute inset-0 rounded-3xl border border-white/10 bg-zinc-950/40 backdrop-blur-sm" />
          <img
