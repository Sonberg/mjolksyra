...
export function PageLayout({ children, fullBleed = false, navigation }: Props) {
  return (
    <div className="font-[var(--font-body)] relative mx-auto w-full overflow-x-clip overflow-y-visible">
      {navigation ? (
        <div className="sticky top-0 z-40 border-b border-[var(--shell-border)] bg-[color-mix(in_srgb,var(--shell-surface),transparent_10%)] px-4 pt-2 backdrop-blur supports-[backdrop-filter]:bg-[color-mix(in_srgb,var(--shell-surface),transparent_6%)]">
