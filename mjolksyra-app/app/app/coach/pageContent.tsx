...
export function PageContent({ trainees, user }: Props) {
  ...
  return (
    <div className="relative space-y-8 py-6 md:py-10">
      <div className="pointer-events-none absolute -top-24 -right-16 h-56 w-56 rounded-full bg-white/8 blur-3xl" />
      <div className="pointer-events-none absolute top-48 -left-24 h-64 w-64 rounded-full bg-white/5 blur-3xl" />
      ...
      <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 px-6 py-8 shadow-[0_20px_80px_rgba(0,0,0,0.35)] md:px-10">
        <div className="absolute -right-10 -top-16 h-52 w-52 rounded-full bg-white/8 blur-3xl" />
