...
import { getAiCreditPacks } from "@/services/aiCreditPacks/getAiCreditPacks";
import { purchaseAiCreditPack } from "@/services/coaches/purchaseAiCreditPack";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { useState } from "react";

export function CoachAiCreditPurchase() {
  ...
  const mutation = useMutation({
    mutationFn: (packId: string) => purchaseAiCreditPack(packId),
    onSuccess: () => {
